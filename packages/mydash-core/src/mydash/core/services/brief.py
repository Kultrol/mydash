...
:class:`~mydash.core.services.user_config.UserConfigurationService` so the CLI
...
from mydash.core.models.stocks import StockBars, StockQuotes
from mydash.core.models.weather import MultiDayForecast
from mydash.core.services.news import NewsService
from mydash.core.services.stocks import StocksService
from mydash.core.services.user_config import (
    DEFAULT_CITY,
...
from mydash.core.services.weather import WeatherService
