...
@pytest.mark.parametrize("mock_results, mock_city, mock_latitude, mock_longitude",
                         [
...
def test_get_coordinates_valid_city_return_coordinates(mocker: MockFixture, mock_results, mock_city:str, mock_latitude:    float, mock_longitude:float) -> None:
...
@pytest.mark.parametrize("city, error_type", [("abracadabra", ValueError),("bob is your uncle", ValueError), (2, ValidationError), ("", ValueError)])
