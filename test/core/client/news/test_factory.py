"""Tests for mydash.core.client.news.factory."""

import pytest

from mydash.core.client.news.base import NewsClient
from mydash.core.client.news.base_errors import NewsFactoryError
from mydash.core.client.news.factory import get_news_client
from mydash.core.client.news.providers.noozra.noozra import NoozraClient
