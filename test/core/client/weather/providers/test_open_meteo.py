"""Tests for mydash.core.client.weather.open_meteo."""
...
from mydash.core.client.weather.factory import get_weather_client
from mydash.core.client.weather.providers.open_meteo.errors import (
